...
class User(object):
    ...
    def __init__(self, uid=None, name=None, age=None, sex=None,):
        self.uid = uid
        self.name = name
        self.age = age
        self.sex = sex
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.sex = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
